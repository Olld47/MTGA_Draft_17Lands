...
- **自动化云端数据集：** 应用使用自定义云端 ETL 流水线，每天编译并分发最新的 17Lands 遥测数据。打开应用时，它会立即在后台同步当前 Arena 赛事的数据，你无需再手动抓取数据。你可以[在此](https://olld47.github.io/MTGA_Draft_17Lands/)查看数据集更新日程。
